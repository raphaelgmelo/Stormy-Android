package com.raphaelgmelo.stormy.ui;
...
import com.raphaelgmelo.stormy.weather.Current;
import com.raphaelgmelo.stormy.weather.Day;
import com.raphaelgmelo.stormy.weather.Forecast;
...
public class MainActivity extends ActionBarActivity {
    ...
    private void GetForecast(double latitude, double longitude) {
        String apiKey = "8f0cb45949faeffdd97e7535089bc70a";
        ...
        if (isNetworkAvailable()) {
            ...
            Toast.makeText(this, getString(R.string.network_unavailable_text),
